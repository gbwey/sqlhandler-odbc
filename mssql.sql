...
create table  customers 
   (	cust_code varchar(6) not null primary key, 
	...
	constraint fk_customer_agent foreign key (agent_code) references agents (agent_code)
);   
...
create table  orders 
   (
	...
	constraint fk_order_customer foreign key (cust_code) references customers (cust_code),

	agent_code char(6) not null, 
	constraint fk_order_agent foreign key (agent_code) references agents (agent_code),
